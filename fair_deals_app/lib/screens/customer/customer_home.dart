...
class customer_HomeScreen extends StatefulWidget {
  final String userId;
  customer_HomeScreen({required this.userId});

  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<customer_HomeScreen> {
  ...
  Future<void> _toggleFavoriteStatus(QueryDocumentSnapshot product) async {
    try {
  ...
  Future<List<Widget>> _buildProductCards(List<QueryDocumentSnapshot> products) async {
    ...
    return results.whereType<Widget>().toList();
  }
                  ...
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () => _toggleFavoriteStatus(product),
                      ),
                      Container(
                        padding: const EdgeInsets.symmetric(
            ...
            itemBuilder: (_, index) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text('${product['price']} OMR'),
